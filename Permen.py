...
""")#line:49
    ...
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/19725344955?text=Bang+Beli+Lisensi+nya+dong...!!!');exit ()#line:52
      ...
      if len (O000O000OOO000OOO )==0 :#line:55
        ...
        with requests .Session ()as O0O0OO0O0O00OOOO0 :#line:58   #### ISI TOKEN LU DAN   ID LU
          OOO00OO00O0O0OOOO =O0O0OO0O0O00OOOO0 .get(f'https://app.cryptolens.io/api/key/activate?token=WyIyNjIwODUyMSIsImVnOXpFODlha09WVFlPSlRiOTRYdkVPWFZvUXpsaWZrMXZrcERwY24iXQ==&ProductId=17023&Key={O000O000OOO000OOO}&Sign=True').json ()['licenseKey']#line:59
      ...
      exit (f"{P}[{M}!{P}]{M} Masukan Salah")#line:65
